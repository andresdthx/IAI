                ...
                <div class="modal-container">
                    <span class="glyphicon glyphicon-remove close-modal" @click="$emit('close')" ></span>
                        ...
                        <form v-on:submit.prevent="onSubmit">
                            ...
                            <h4 class="step-title">Nombre del investigador principal*</h4>
...
export default {
    ...
    data() {
        return {
            nombre: this.subproyecto.nombre,
            descripcion: this.subproyecto.descripcion,
            investigador_principal: this.subproyecto.investigador_principal,
            errors: {},
        }
    },
    ...
    methods: {
        ...
        onSubmit: function () {
            this.errors = {};
            axios.put(`/subproyectos/${this.subproyecto.id}`, { 
                nombre: this.nombre, 
